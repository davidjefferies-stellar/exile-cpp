...
void Game::apply_player_input(Object& player, const InputState& inp_in,
    ...
    // rotates with tcA so accel runs along the slope tangent.
        // walking_speed = #&1f at &3a8f. max_accel computed at &3abd-&3ac4
        // from this_object_weight (&38 = 3 for player): LDA #&0f, one LSR
        // with C=1 carrying into ADC #&01 -> 0x09. apply_weight_and_limit
